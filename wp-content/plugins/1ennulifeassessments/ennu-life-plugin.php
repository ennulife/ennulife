...
require_once ENNU_LIFE_PLUGIN_PATH . 'includes/class-admin.php';
    ...
    private function should_load_assets() {
        ...
        if ( is_page() && $post ) {
            $ennu_pages = array(
                'welcome-assessment', 'health-assessment', 'weight-loss-assessment', 'skin-assessment',
    ...
    private function has_ennu_shortcodes( $content ) {
        $ennu_shortcodes = array(
            'ennu-main-landing', 'ennu-welcome-assessment', 'ennu-health-assessment', 'ennu-weight-loss-assessment',
